...
export function Navbar() {
  ...
  const navItems = [
    { label: 'Home', id: 'home' },
    { label: 'Home Near Me', id: 'near-me' },
    { label: 'Home For Rent', id: 'for-rent' },
    { label: 'Pre-Approval', id: 'pre-approval' },
        ...
        <div className="w-full max-w-6xl">
          <div className="bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 border border-white/20">
            <div className="flex items-center justify-between h-14">
              {/* Logo */}
              <Link href="/" className="text-white font-medium text-sm tracking-wide hover:opacity-80 transition-opacity">
               RoostFinder
              </Link>
              ...
              <div className="flex items-center space-x-3">
                <Button 
                  size="sm"
                  className="hidden md:flex bg-gradient-to-r from-lime-400 via-green-400 to-emerald-500 hover:from-lime-500 hover:via-green-500 hover:to-emerald-600 text-slate-900 font-semibold rounded-full px-6 transition-all duration-300"
                >
                  Login
                </Button>
            ...
            {isOpen && (
              <div className="md:hidden mt-3 pb-4 space-y-2 animate-in fade-in slide-in-from-top-2 duration-200">
                ...
                <Button 
                  size="sm"
                  className="w-full mt-2 bg-gradient-to-r from-lime-400 via-green-400 to-emerald-500 hover:from-lime-500 hover:via-green-500 hover:to-emerald-600 text-slate-900 font-semibold rounded-full transition-all duration-300"
                >
                  Login
                </Button>
              </div>
